// Todas as texturas do jogo são geradas em tempo real com Graphics (pixel art procedural)
...
export function generateTextures(scene) {
    ...
    const tv = (key, on) => {
        ...
        g.fillStyle(0x3a3a44); g.fillRect(2, 16, 80, 52);            // caixa
        g.fillStyle(0x24242c); g.fillRect(2, 16, 80, 5);
        if (on) {
            g.fillStyle(0x9be8ff); g.fillRect(9, 24, 54, 38);        // tela ligada
            g.fillStyle(0xffffff, 0.9); g.fillCircle(36, 42, 8);
            g.fillStyle(0xfff3b0, 0.8); g.fillRect(12, 27, 10, 32);
        } else {
            g.fillStyle(0x1c2340); g.fillRect(9, 24, 54, 38);        // tela apagada
    ...
    // ---------- perigos ----------
    g.clear(); // tênis
    g.fillStyle(0xd90429); g.fillRect(0, 6, 34, 12); g.fillRect(24, 0, 18, 18);
    g.fillStyle(0xffffff); g.fillRect(0, 16, 44, 6);             // sola
    g.fillRect(28, 4, 10, 3);                                    // detalhe
    g.fillStyle(0xf1f1f1); g.fillRect(6, 8, 3, 6); g.fillRect(13, 8, 3, 6); // cadarço
    g.generateTexture('sneaker', 44, 22);

    const lego = (key, color, dark) => {
        g.clear();
        g.fillStyle(color); g.fillRect(0, 8, 26, 14);
        g.fillRect(3, 2, 7, 6); g.fillRect(15, 2, 7, 6);          // pinos
    ...
    g.fillStyle(0x9d4edd); g.fillRect(0, 8, 38, 8);
    g.fillStyle(0xefe9f7); g.fillRect(34, 9, 3, 6);
    g.fillStyle(0xff9f1c); g.fillRect(4, 0, 30, 8);
    ...
    // ---------- robô ----------
    g.clear();
    g.fillStyle(0x333640); g.fillRect(2, 24, 30, 8);              // esteira
    g.fillStyle(0x777d8a); g.fillCircle(8, 28, 3); g.fillCircle(17, 28, 3); g.fillCircle(26, 28, 3);
    g.fillStyle(0x9aa5b1); g.fillRect(4, 8, 26, 16);              // corpo
    g.fillStyle(0xb8c2cc); g.fillRect(4, 8, 26, 3);
    g.fillStyle(0x22262e); g.fillRect(7, 12, 20, 7);              // visor
    g.fillStyle(0xff4757); g.fillRect(10, 14, 4, 3); g.fillRect(20, 14, 4, 3); // olhos
    ...
    // ---------- almofada-mola ----------
    g.clear();
    g.fillStyle(0xff7096); g.fillRect(2, 4, 40, 12);
    g.fillStyle(0xffa5c0); g.fillRect(2, 4, 40, 4);
    g.fillStyle(0xd44d74); g.fillRect(2, 13, 40, 3);
    g.fillStyle(0xb23557); g.fillCircle(22, 10, 2.5);             // botão central
    g.fillStyle(0xd44d74); g.fillRect(0, 15, 44, 3);              // base
    g.generateTexture('cushion', 44, 18);

    // ---------- plataforma móvel ----------
    g.clear();
    g.fillStyle(0xc98f57); g.fillRect(0, 0, 96, 14);
    g.fillStyle(0xe0aa70); g.fillRect(0, 0, 96, 4);
    ...
    // ---------- decoração de fundo ----------
    g.clear(); // janela
    g.fillStyle(0x8a5a2e); g.fillRect(0, 0, 110, 130);
    gradientStrips(g, 8, 8, 94, 114, 0x9fd8ff, 0xd8f0ff, 8);
    g.fillStyle(0xffffff, 0.9); g.fillRect(18, 30, 30, 8); g.fillRect(30, 38, 30, 8); // nuvens
    g.fillRect(55, 70, 34, 8);
    ...
    g.clear(); // sofá
    g.fillStyle(0xc45b4e); g.fillRect(10, 8, 140, 34);           // encosto
    g.fillStyle(0xd97a6c); g.fillRect(0, 34, 160, 24);           // assento
    g.fillStyle(0xc45b4e); g.fillRect(0, 24, 24, 40); g.fillRect(136, 24, 24, 40); // braços
    ...
    g.clear(); // quadro
    g.fillStyle(0xd4a017); g.fillRect(0, 0, 58, 68);
    ...
    g.fillStyle(0xb5651d); g.fillRect(12, 54, 28, 26);           // vaso
    ...
    g.fillRect(6, 90, 27, 8);
    g.generateTexture('lamp', 39, 98);

    g.clear(); // estante com livros
    g.fillStyle(0x8a5a2e); g.fillRect(0, 0, 110, 140);
    ...
    g.clear(); // geladeira
    g.fillStyle(0xdfe7ea); g.fillRect(0, 0, 64, 120);
    g.fillStyle(0xc3ced4); g.fillRect(0, 44, 64, 4);
    g.fillStyle(0x8a969c); g.fillRect(52, 14, 5, 22); g.fillRect(52, 56, 5, 34); // puxadores
    g.fillStyle(0xf2f7f9); g.fillRect(0, 0, 64, 5);
    g.generateTexture('fridge', 64, 120);

    g.clear(); // mesa
    g.fillStyle(0x8a5a2e); g.fillRect(0, 0, 130, 12);
    ...
    g.fillStyle(0xc89b6a); g.fillRect(0, 6, 64, 46);
